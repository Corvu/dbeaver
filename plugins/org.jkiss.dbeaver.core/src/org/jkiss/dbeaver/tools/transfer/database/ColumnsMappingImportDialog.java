 ...
 */
public class ColumnsMappingImportDialog extends StatusDialog {
    ...
    public ColumnsMappingImportDialog(DataTransferImportWizard wizard, DatabaseConsumerSettings settings, DatabaseMappingContainer mapping)
    {
