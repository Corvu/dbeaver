...
public class DatabaseProducerImportPageExtractSettings extends ActiveWizardPage<DataTransferImportWizard> {
    ...
    public DatabaseProducerImportPageExtractSettings() {
