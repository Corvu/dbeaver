...
import org.jkiss.dbeaver.tools.transfer.wizard.DataTransferImportWizard;
...
public class DatabaseConsumerImportPageMapping extends ActiveWizardPage<DataTransferImportWizard> {

    private static final Log log = Log.getLog(DatabaseConsumerImportPageMapping.class);
    ...
    public DatabaseConsumerImportPageMapping() {
...
*/
    ...
    private void createMappingsTree(Composite composite)
    {
        ...
        columnTarget.setEditingSupport(new EditingSupport(mappingViewer) {
            ...
            {
                try {
                    final DatabaseConsumerSettings settings = getWizard().getPageSettings(DatabaseConsumerImportPageMapping.this, DatabaseConsumerSettings.class);
    ...
    {
        ColumnsMappingImportDialog dialog = new ColumnsMappingImportDialog(
            getWizard(),
