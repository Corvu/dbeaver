...
class DataTransferImportPageFinal extends ActiveWizardPage<DataTransferImportWizard> {

    private static final Log log = Log.getLog(DataTransferImportPageFinal.class);

    private Table resultTable;
    private boolean activated = false;

    DataTransferImportPageFinal() {
