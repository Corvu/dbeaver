 ...
 */
public class DataTransferImportRegistry {

    public static final String EXTENSION_ID = "org.jkiss.dbeaver.dataTransferImport"; //$NON-NLS-1$

    private static DataTransferImportRegistry instance = null;

    public synchronized static DataTransferImportRegistry getInstance()
    {
        if (instance == null) {
            instance = new DataTransferImportRegistry(Platform.getExtensionRegistry());
        }
        return instance;
    }
    ...
    private DataTransferImportRegistry(IExtensionRegistry registry)
    {
