...
public class MySQLTableColumn extends JDBCTableColumn<MySQLTableBase> implements DBSTableColumn, DBPNamedObject2
{
        ...
        throws DBException
    {
        ...
        this.collation = JDBCUtils.safeGetString(dbResult, MySQLConstants.COL_COLLATION_NAME);
    ...
    {
        return collation == null ? null : getDataSource().getCharsetByCollation(collation);
    }
